...
4. Positive business critical workflow is prioritized followed by Negative tests to avoid data integrity issues.
...
* [BankOperationsAPIAutomation Repository](https://github.com/Krishna-teja-92/BankOperationsAPIAutomation.git)